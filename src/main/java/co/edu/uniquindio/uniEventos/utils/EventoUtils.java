...
public class EventoUtils {
    public Evento crearEvento(String nombre, String ciudad, String descripcion, TipoEvento tipoEvento, LocalDate fecha, ArrayList<Localidad> localidades, String prefijo, String direccion) throws Exception {
        try {
