...
public class PanelUsuarioController implements Initializable {
    ...
    public void filtrarEventos() {
        ...
        System.out.println(eventosFiltrados);
    ...
    public void cerrarSesion() {
        ButtonType respuesta = controladorPrincipal.mostrarAlerta("¿Está seguro de cerrar la sesión?", Alert.AlertType.CONFIRMATION);
